...
import { useDjangoCourses, getCourseCategories } from "@/hooks/useDjangoCourses";
...
const heroSlides = [
  ...
  function getCategoryDescription(categoryName: string) {
    const descriptions: { [key: string]: string } = {
      'Languages': 'Master global languages with native speakers and cultural immersion',
      'Programming': 'Build modern applications with cutting-edge technologies',
      'Design': 'Create stunning visuals and user experiences',
      'Healthcare': 'Professional medical and healthcare training',
      'Business': 'Develop leadership and management skills',
      'Mathematics': 'Enhance analytical and problem-solving abilities',
      'General': 'Diverse courses for personal and professional growth'
    };
  ...
  function getCategoryGradient(categoryName: string) {
    const gradients: { [key: string]: string } = {
      ...
      'Healthcare': 'bg-gradient-to-br from-red-500 to-rose-600',
      'Business': 'bg-gradient-to-br from-orange-500 to-amber-600',
      'Mathematics': 'bg-gradient-to-br from-cyan-500 to-blue-600',
    ...
    <Layout>
      ...
      <section className="py-24 bg-gradient-to-br from-secondary/30 via-background to-secondary/20 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative">
          ...
          {(coursesLoading || djangoCoursesLoading) ? (
          ...
          ) : (coursesError || djangoCoursesError) ? (
            <div className="text-center py-12">
              <div className="text-destructive mb-4">
                ...
                <p className="text-muted-foreground mb-4">
                  {coursesError || (djangoCoursesError instanceof Error ? djangoCoursesError.message : djangoCoursesError)}
                </p>
