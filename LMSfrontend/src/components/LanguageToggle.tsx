    ...
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        <Button
          variant="ghost"
          size="sm"
          className="h-10 w-10 px-0 rounded-full hover:bg-accent/50 transition-all duration-300 hover:scale-105 hover:rotate-6 relative group"
        >
          <Languages className="h-5 w-5 transition-transform duration-300 group-hover:scale-105 text-foreground" />
