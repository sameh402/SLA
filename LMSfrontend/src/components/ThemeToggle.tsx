    ...
    <DropdownMenu>
      ...
      >
        ...
        >
          ...
          <span className="font-medium text-foreground">فاتح</span>
          {theme === "light" && (
        ...
        >
          ...
          <span className="font-medium text-foreground">داكن</span>
          {theme === "dark" && (
        ...
        >
          ...
          <span className="font-medium text-foreground">النظام</span>
          {theme === "system" && (
