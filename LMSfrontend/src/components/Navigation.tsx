...
export function Navigation() {
  ...
  return (
    <header className="sticky top-0 z-50 w-full border-b border-border bg-background/80 backdrop-blur-xl supports-[backdrop-filter]:bg-background/60 transition-all duration-300 shadow-sm">
  ...
  />
        ...
        <Sheet open={isOpen} onOpenChange={setIsOpen}>
          ...
          <SheetContent
            ...
            className="pr-0 bg-background border-border"
          >
            <VisuallyHidden>
